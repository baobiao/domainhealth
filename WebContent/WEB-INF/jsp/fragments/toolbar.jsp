			...
			<table border="0" cellpadding="1" cellspacing="0">
				<tr>
					...
					<td align="center" valign="middle">
						<a href='<c:out value="${pageurl}"/>?datetime=<c:out value="${datetime}"/>&duration=<c:out value="${duration}"/>&scope=<c:out value="${scope}"/>&direction=firstdate' onmouseover="firstday.src='<c:out value="${contexturl}"/>/images/buttons/first_hover.png'" onmouseout="firstday.src='<c:out value="${contexturl}"/>/images/buttons/first.png'"><img name="firstday" border="0" height='40' width='40' alt="Earliest Day" title="Earliest Day" src='<c:out value="${contexturl}"/>/images/buttons/first.png'/></a>			
					</td>
					
					<%-- Previous Day Button --%>
					<td align="center" valign="middle">
						<a href='<c:out value="${pageurl}"/>?datetime=<c:out value="${datetime}"/>&duration=<c:out value="${duration}"/>&scope=<c:out value="${scope}"/>&direction=previousdate' onmouseover="previousday.src='<c:out value="${contexturl}"/>/images/buttons/previous_hover.png'" onmouseout="previousday.src='<c:out value="${contexturl}"/>/images/buttons/previous.png'"><img name="previousday" border="0" height='40' width='40' alt="Previous Day" title="Previous Day" src='<c:out value="${contexturl}"/>/images/buttons/previous.png'/></a>
					</td>
					...
					<%-- Next Day Button --%>
					<td align="center" valign="middle">
						<a href='<c:out value="${pageurl}"/>?datetime=<c:out value="${datetime}"/>&duration=<c:out value="${duration}"/>&scope=<c:out value="${scope}"/>&direction=nextdate' onmouseover="nextday.src='<c:out value="${contexturl}"/>/images/buttons/next_hover.png'" onmouseout="nextday.src='<c:out value="${contexturl}"/>/images/buttons/next.png'"><img name="nextday" border="0" height='40' width='40' alt="Next Day" title="Next Day" src='<c:out value="${contexturl}"/>/images/buttons/next.png'/></a>
					</td>

					<%-- Last Day Button --%>
					<td align="center" valign="middle">
						<a href='<c:out value="${pageurl}"/>?datetime=<c:out value="${datetime}"/>&duration=<c:out value="${duration}"/>&scope=<c:out value="${scope}"/>&direction=lastdate' onmouseover="lastday.src='<c:out value="${contexturl}"/>/images/buttons/last_hover.png'" onmouseout="lastday.src='<c:out value="${contexturl}"/>/images/buttons/last.png'"><img name="lastday" border="0" height='40' width='40' alt="Today" title="Today" src='<c:out value="${contexturl}"/>/images/buttons/last.png'/></a>
					</td>
				</tr>
			</table>
		</td>
		...
		<td align="right" valign="middle" width="30%">
			<table border="0" cellpadding="1" cellspacing="0">		
				<tr>
					...
					<td align="center" valign="middle">
						<a href='<c:out value="${pageurl}"/>?datetime=<c:out value="${datetime}"/>&duration=<c:out value="${duration}"/>&scope=<c:out value="${scope}"/>&direction=nexttime' onmouseover="nexttime.src='<c:out value="${contexturl}"/>/images/buttons/next_hover.png'" onmouseout="nexttime.src='<c:out value="${contexturl}"/>/images/buttons/next.png'"><img name="nexttime" border="0" height='40' width='40' alt="Next Hour" title="Next Time Period" src='<c:out value="${contexturl}"/>/images/buttons/next.png'/></a>
					</td>
					
					<%-- Latest Time This Day Button --%>					
					<td align="center" valign="middle">
						<a href='<c:out value="${pageurl}"/>?datetime=<c:out value="${datetime}"/>&duration=<c:out value="${duration}"/>&scope=<c:out value="${scope}"/>&direction=lasttime' onmouseover="lasttime.src='<c:out value="${contexturl}"/>/images/buttons/last_hover.png'" onmouseout="lasttime.src='<c:out value="${contexturl}"/>/images/buttons/last.png'"><img name="lasttime" border="0" height='40' width='40' alt="Latest Time this Day" title="Latest Time this Day" src='<c:out value="${contexturl}"/>/images/buttons/last.png'/></a>
					</td>
